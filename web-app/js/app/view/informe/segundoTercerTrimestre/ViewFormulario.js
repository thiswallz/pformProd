Ext.define('PForm.view.informe.segundoTercerTrimestre.ViewFormulario', {
    extend: 'Ext.window.Window',
    alias : 'widget.segundotercertrimestreviewform',
    ...
    listeners: {
        afterlayout: function (win) {
            ...
            Ext.Ajax.request({
                scope: this,
                url: 'segundoTercerTrimestres/getFields',
                params: {
                    id: me.idInforme
                },
                success: function(response){
                    ...
                    form.getForm().reset()
                    var mod = new PForm.model.SegundoTercerTrimestre(jsonin.data)
                    form.loadRecord(mod)
