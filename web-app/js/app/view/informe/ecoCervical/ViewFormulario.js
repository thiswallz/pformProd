Ext.define('PForm.view.informe.ecoCervical.ViewFormulario', {
    extend: 'Ext.window.Window',
    alias : 'widget.ecocervicalviewform',
        ...
        afterlayout: function (win) {
            ...
            Ext.Ajax.request({
                ...
                success: function(response){
                    ...
                    form.getForm().reset()
                    var mod = new PForm.model.EcoCervical(jsonin.data)
                    form.loadRecord(mod)
