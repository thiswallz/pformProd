Ext.define('PForm.view.informe.primerTrimestre.ViewFormulario', {
    extend: 'Ext.window.Window',
    alias : 'widget.primertrimestreviewform',
    ...
    listeners: {
        afterlayout: function (win) {
            ...
            Ext.Ajax.request({
                scope: this,
                url: 'primerTrimestres/getFields',
                params: {
                    id: me.idInforme
                },
                success: function(response){
                    ...
                    form.getForm().reset()
                    var mod = new PForm.model.PrimerTrimestre(jsonin.data)
                    form.loadRecord(mod)
                },
