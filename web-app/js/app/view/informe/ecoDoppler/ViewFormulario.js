Ext.define('PForm.view.informe.ecoDoppler.ViewFormulario', {
    extend: 'Ext.window.Window',
    alias : 'widget.ecodopplerviewform',
        ...
        afterlayout: function (win) {
            ...
            Ext.Ajax.request({
                ...
                success: function(response){
                    ...
                    form.getForm().reset()
                    var mod = new PForm.model.EcoDoppler(jsonin.data)
                    form.loadRecord(mod)
