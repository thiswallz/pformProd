...
Ext.define('PForm.model.Perfil', {
    ...
    fields: [
		...
		{name: 'biofisPerfilMovCorporales', type: types.AUTO},
		{name: 'biofisPerfilMovRespiratorio', type: types.AUTO},
		{name: 'biofisPerfilTonoFetal', type: types.AUTO},
		{name: 'biofisPerfilLiquidoOvular', type: types.AUTO},
